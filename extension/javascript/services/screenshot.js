var ScreenshotService = function(){
  ...
  function startCapturingScreenshot(e) {
    ...
    elementPosition = { x: e.pageX, y: e.pageY };
  ...
  function drawingScreenshotFunc(e){
    ...
    $screenshotElement
      .css('left', e.pageX > elementPosition.x ? elementPosition.x : e.pageX)
      .css('top', e.pageY > elementPosition.y ? elementPosition.y : e.pageY)
  ...
  function capturedScreenshotFunc(e){
    ...
    var finalHeight = Math.abs(mousePosition.y - startingPosition.y) * PIXEL_DENSITY;
